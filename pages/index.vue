<template>
  <div class="min-h-screen bg-gray-100 flex flex-col">
    ...
    <Navbar>
      ...
      <a href="#" class="hover:text-blue-400 transition duration-300">Features</a>
      <a href="#" class="hover:text-blue-400 transition duration-300">Components</a>
      <a href="#" class="hover:text-blue-400 transition duration-300">Contact</a>
    </Navbar>

    <!-- Header Section -->
    <header class="bg-gradient-to-r from-blue-700 to-blue-500 text-white text-center py-16">
      <h1 class="text-5xl font-extrabold">Welcome to DannUI</h1>
      <p class="mt-4 text-xl">Modern UI components for Vue.js and Nuxt.js</p>
      <Button color="primary" size="lg" @click="scrollToComponents" class="mt-8">
        Explore Components
      </Button>
    </header>
    ...
    <main class="container mx-auto px-4 py-16 flex-grow" id="components">
      ...
      <section class="mb-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
          <Card color="white">
            <template #header>
              <h3 class="text-2xl font-semibold">Card Title 1</h3>
            </template>
            <template #content>
              <p class="text-gray-600">This is a simple card with a white background.</p>
            </template>
            <template #footer>
          ...
          <Card color="dark">
            <template #header>
              <h3 class="text-2xl font-semibold">Card Title 2</h3>
            </template>
            <template #content>
              <p class="text-gray-400">This is a dark-themed card with customized content.</p>
            </template>
            <template #footer>
      ...
      <section class="mb-16">
        ...
        <div class="flex justify-center">
          <Dropdown label="Select an option" :items="dropdownItems" @select="handleDropdownSelect" />
        </div>
        <p class="text-center mt-6 text-lg">Selected: {{ selectedDropdown }}</p>
      </section>
      ...
      <section>
        ...
        <Modal :isOpen="isModalOpen" @close="closeModal">
          ...
          <p class="mt-4">This is a customizable modal where you can place any content.</p>
          <template #footer>
            <Button color="secondary" @click="closeModal">Close</Button>
          </template>
        </Modal>
      </section>
    </main>
